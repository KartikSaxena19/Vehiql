...
const AddCarForm = () => {
  ...
  const {
    getRootProps: getMultiImageRootProps, //Renaming
  ...
  const processWithAI=async()=>{
    if(!uploadedAiImage){
      toast.error("Please upload an imae first")
      return
    }
    await processImageFn(uploadedAiImage)
  }

  //for error in ai uploading
  useEffect(()=>{
            ...
            <CardContent>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-500 mb-2">
                        Drag & drop a car image or click toupload multiple
                        images
                      </p>
                ...
                {uploadedImages.length > 0 && (
                  <div>
                    <h3>Upload Images ({uploadedImages.length})</h3>
                        ...
                        return (
                          <div key={index} className="relative group">
                            ...
                            <Button
                              ...
                              variant={"destructive"}
                              className={
                                "bg-red-600  absolute opacity-0 hover:opacity-100 right-1 top-1 h-6 w-6  "
                              }
