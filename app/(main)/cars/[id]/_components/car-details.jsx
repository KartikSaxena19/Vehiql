"use client";
import { toggleSavedCar } from "@/actions/car-lisitng";
...
import { Car, Currency, Fuel, Gauge, Heart, MessageSquare, Share2, Calendar, LocateFixed } from "lucide-react";
...
const CarDetails = ({ car, testDriveInfo }) => {
  ...
  return (
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="w-full lg:w-7/12">
          <div className="aspect-video rounded-lg overflow-hidden relative mb-4">
            {car.images && car.images.length > 0 ? (
              ...
              <div className="w-full h-full bg-gray-200 flex items-center">
                <Car className="h-24 w-2/4 text-gray-400" />
              </div>
            )}
          </div>
          {/* Thumbnails */}
          ...
          <div className="flex mt-4 gap-4">
            <Button
              variant="outline"
              className={`flex hover:bg-gray-100 items-center gap-2 flex-1 ${
        ...
        <div className="w-full lg:w-5/12">
          <div className="flex mb-2 items-center justify-between bg-black text-white w-fit rounded-xl p-1">
    ...
    {/* Details & Features Section */}
      ...
      <div className="mt-8 p-6 rounded-lg shadow-sm dotted-background">
        <h2 className="text-2xl text-white font-bold mb-6">Dealership Location</h2>
        <div className=" rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium text-white">Vehiql Motors</h4>
            ...
            <div className="md:w-1/2 lg:w-1/3 ">
              <h4 className="font-medium mb-2 text-white">Working Hours</h4>
